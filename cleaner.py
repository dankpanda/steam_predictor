...
doc = "apparently definitive edition want lazy copy paste original mafia 2 bug size incompetent work hangar 13 dont buy remake"
...
for i in a.index:
    review = a.at[i,'review']
    new_review = space(review)
    a.at[i,'review'] = new_review 
